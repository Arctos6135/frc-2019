...
/**
 * Rotates the robot in place a certain number of degrees in a specified
 * direction. This command uses the {@link frc.robot.commands.FollowTrajectory
 * FollowTrajectory} command internally and thus requires RobotPathfinder to be
 * properly tuned.
 */
public class RotateToAngle extends Command {
	...
	public RotateToAngle(double angle, Direction direction) {
		...
		// Use a RobotPathfinder trajectory here to save time and improve accuracy with
		// the already tuned PIDs
	...
	protected void initialize() {
		...
		// We cannot actually start the FollowTrajectory command, as it also requires
		// drivetrain and will interrupt this command.
		// Therefore we must call its methods manually without handing control to
		// WPILib.
