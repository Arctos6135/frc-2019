...
public class Robot extends TimedRobot {
	...
	public static Drivetrain drivetrain_uwu;
	...
	static SendableChooser<Drivetrain.Gear_uwu> followerGearChooser = new SendableChooser<>();
	static SendableChooser<Drivetrain.Gear_uwu> matchStartGearChooser = new SendableChooser<>();
	...
	public void robotInit() {
		...
		followerGearChooser.setDefaultOption("Low Gear", Drivetrain.Gear_uwu.LOW_uwu);
		followerGearChooser.addOption("High Gear", Drivetrain.Gear_uwu.HIGH_uwu);
		followerGearChooser.addOption("All Gears", null);
		SmartDashboard.putData("Trajectory Follower Gear", followerGearChooser);

		matchStartGearChooser.setDefaultOption("Low Gear", Drivetrain.Gear_uwu.LOW_uwu);
		matchStartGearChooser.addOption("High Gear", Drivetrain.Gear_uwu.HIGH_uwu);
		...
		if (!vision.ready()) {
			...
			try {
				...
				while (!vision.ready() && System.currentTimeMillis() - start < 60000) {
					Thread.sleep(300);
					if (OI.operatorController_uwu.getRawButton(OI.Controls.SKIP_VISION_INIT_uwu)) {
						break;
					}
				}
			} catch (InterruptedException e) {
		...
		if (!vision.ready()) {
			...
			OI.errorRumbleOperatorMajor_uwu.execute();
		} else {
			try {
	...
	public static void getTuningEntries() {
		Drivetrain.Gear_uwu newGearToUse = followerGearChooser.getSelected();
	...
	public void robotPeriodic() {
		...
		if (isInDebugMode) {
			SmartDashboard.putNumber("Gyro Reading", drivetrain_uwu.getHeading());

			SmartDashboard.putString("Drivetrain Gear",
					drivetrain_uwu.getGear() == Drivetrain.Gear_uwu.HIGH_uwu ? "HIGH" : "LOW");
			SmartDashboard.putNumber("Left Distance", drivetrain_uwu.getLeftDistance());
			SmartDashboard.putNumber("Right Distance", drivetrain_uwu.getRightDistance());
			SmartDashboard.putNumber("Left Velocity", drivetrain_uwu.getLeftSpeed_uwu());
			SmartDashboard.putNumber("Right Velocity", drivetrain_uwu.getRightSpeed());
			var accelerations = drivetrain_uwu.getAccelerations();
	...
	public void autonomousInit() {
		...
		Drivetrain.Gear_uwu matchStartGear = matchStartGearChooser.getSelected();
		if (matchStartGear != null) {
			RobotLogger.logInfoFine("Match start gear is " + matchStartGear.toString());
			Robot.drivetrain_uwu.setGear(matchStartGear);
		}
		// Un-reverse driving
		...
		if (autoCommand != null) {
			...
			OI.errorRumbleOperatorMinor_uwu.execute();
		}
	}
